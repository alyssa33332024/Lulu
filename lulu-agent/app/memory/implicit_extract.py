"""Implicit long-term extract helpers (profile/preference/procedure → memory2).

Extracted from Akashic default_memory engine; DefaultMemoryEngine plugin path removed.
"""
